...

{
    public class Transaction_old
    {
        ...
        public Transaction_old(TransactionType type, TransactionStatus status, OperationStatus opestat, DateTime dateTransaction, int id = 0, double somme = 0, int transmetteur = 0, int recepteur = 0)
        {
            Id = id;
        ...
        /*public Transaction_old(int id=0,double somme=0,int transmetteur=0,int recepteur=0)
		{
